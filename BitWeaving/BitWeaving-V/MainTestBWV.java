...
public class MainTestBWV {
	...
	public static void main(String[] args) {		
		...
		// Nombre de queries  faire  la suite
		int nbQueries = 300;
		
		// Nombre de queries  ignorer
		int nbQueriesIgnored = 20;
		
		// Proba. d'ajouter une donne  chaque query
		double pbAdd = 0.5;
		...
		// k0 = taille d'une donne en bits
		// w0 = largeur du mot processeur
		// columnlength0 = taille de la colonne d'entiers alatoires cods sur k0 bits
		// La requte est exprime par queryName0 pour la constante cst0
		// 	ex: pour avoir toutes les donnes infrieures  5: cst0 = 5 et queryName = "LESS THAN"
		...
		if(rest>0) {
			...
			long result = BVout[n] & maskIncompleteSegment; // ici bug de compatibilit avec Benoit!
			if(display || result != resultWanted) {
